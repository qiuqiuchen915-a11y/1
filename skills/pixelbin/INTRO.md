...
> _GPT/Codex reads this file the first time the skill activates. Whatever the user says next, **start by reading this file** and respond in the friendly, chat-first style described here._
...
## How GPT/Codex should respond (instructions for the assistant)
